...
INSERT INTO public.application (id,internship_id,user_id,status, email, full_name, message) VALUES (DEFAULT,1,1,'A','some@gmail.com','some one','Palun võtke tööle. Raha on vaja. Hirmsasti!');